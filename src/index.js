...
function fomartAttr(attr) {
  return attr === '' || attr === 'true' || attr;
}
    ...
    Vue.directive('video', {
      ...
      inserted: function (el, binding, vnode) {
          ...
          var videoPlayer = videojs(el, {
              ...
              responsive: true,
              controls: fomartAttr(attrs.controls),
              autoplay: fomartAttr(attrs.autoplay),
              preload: attrs.preload || 'auto',
              loop: fomartAttr(attrs.loop),
              muted: fomartAttr(attrs.muted),
              poster: attrs.poster || '',
              ...
              language: 'zh-CN'
          }, readyCallBack(fomartAttr(attrs.autofullscreen)));
